...
import md5
from wellness.applogic.admin_module import UserAdmin,db
...
class Authentication:
          ...
          def authenticateAdmin(self):
                    ...
                    try:
                              ...
                              res = session.query(UserAdmin).filter(UserAdmin.username==username).filter(UserAdmin.passwd==passwd).first()
