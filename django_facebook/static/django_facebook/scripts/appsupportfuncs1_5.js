...
{
$('#main_interface_wrapper').load('http://ict4d01.cs.uct.ac.za/facebook/cmd/F3',function(){  
...
jQuery.ajax({
       url: "http://ict4d01.cs.uct.ac.za/facebook/dataupdate/SM/",//save meal to the database
      type: "POST",
...
jQuery.ajax({
       url: "http://ict4d01.cs.uct.ac.za/facebook/dataupdate/SW/",
      type: "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
      success: function(result) {
...
jQuery.ajax({
	  url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/RSB/",
      type: "POST",
	  cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
//Retrieve score board
jQuery.ajax({
	  url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/RSG/",
      type: "POST",
	  cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
var big_fish=["3_","5_","6_","7_","8_","9_","18_","kujira","shark"];
var limit=3;
var ranking=3;
...
function selectBigFishType(){
   ...
   do{
   	var num=randomIntFromInterval(0,8);
      for(iter=0;iter<limit;iter++){
      	
          if((limit<(big_fish.length/2)) &&(big_fish[num]=="shark")||(big_fish[num]=="6_"))
      		{//deny a shark for those with the limit that is less than the number of sharks available.
      	...
      	if(selectedBigfishTypes[iter]==big_fish[num]){
      		 break;
      ...
      if(iter==limit)
      {
         if((!prohibited))
         {
         	  selectedBigfishTypes[i]=big_fish[num];
         	  
         	  break;
         	}
         	else
         	  i--;// take i one step back
...
for(var i=0;i<limit;i++){
	msg=msg+"-";
	msg=msg+selectedBigfishTypes[i];
...
function drawAquirium(box)
{
          ...
          fish_posn=fish_posn+selectedFish[i][2];;
           ...
           var fish=document.getElementById(fish_posn);
              ...
              cx.drawImage(fish,  selectedFish[i][0], selectedFish[i][1], fish.width, fish.height);      
            ...
            //  alert(limit);
              ...
              str=str+rank;
               ...
               $("#teamscoreaquirium").append(str);
	            ...
	            time_out_draw_aquarium.push(setInterval(function(){drawAquirium(displayed_box) }, 100));	
...
//Retrieve score board
jQuery.ajax({
	  url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/RST/",
      type: "POST",
	  cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
function updateLocalStorage(item,tuple,option)
{
  ...
  jQuery.ajax({
	  ...
	  url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/RAD/",
      type: "POST",
	  cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
function extractActivityDataPoints(result)
{
	 ...
	 if((result.R00!==undefined))
	 {
	   ...
	   //$('#main_interface_wrapper').load('http://ict4d01.cs.uct.ac.za/facebook/cmd/FG');
	 }
	 else
	    return;
...
function showScoreBoard(result)
{
	 var score_keys_length=0;
	  var score_fields_keys_length=0;
       ...
       var str="";
       var str2="<tr><td>Rank</td><td>Team</td><td>T</td><td>F</td><td>Total</td></tr>";
       //$("#scoreboard").text("");
...
//$('#main_interface_wrapper').load('http://ict4d01.cs.uct.ac.za/facebook/cmd/DWP/',function(){  
jQuery.ajax({
      //url: "http://localhost/cgi-bin/plot_activity_graph.py",
	  url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/PAG/",
     type: "POST",
	  cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
jQuery.ajax({
	  url: "http://ict4d01.cs.uct.ac.za/facebook/dataupdate/SC/",
       type: "POST",
	     cache: false,
        contentType: "application/json",
        data: JSON.stringify(jsonObjects),
...
jQuery.ajax({
      ...
      url: "http://ict4d01.cs.uct.ac.za/facebook/dataupdate/SA/",
      type: "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
      success: function(result) {
...
jQuery.ajax({
      //url: "http://localhost/cgi-bin/plot_activity_graph.py",
	  url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/PWG/",
      type: "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
        error:function(xhr){
...
jQuery.ajax({
      url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/PMG/",
      type: "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
      error:function(xhr){
...
jQuery.ajax({
      url: "http://ict4d01.cs.uct.ac.za/facebook/dataupdate/SAG/",
      type: "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
      success: function(result) {
...
jQuery.ajax({
      url: "http://ict4d01.cs.uct.ac.za/facebook/dataupdate/SMG/",
      type: "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
function retrieveWeight(){
   var  jsonObjects= {Points:pointsscored,ClicksCounter:clickscounter,DateCaptured:$('#date_captured_weight').val() };
                      ...
                      jQuery.ajax({
      						url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/RW/",
     						type: "POST",
      						contentType: "application/json",
      						data: JSON.stringify(jsonObjects),
 ...
 function retrieveMealsGoal()
{
                     var jsonObjects={Empty:''};
			         	jQuery.ajax({
      						url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/RMG/",
     						type: "POST",
      						contentType: "application/json",
      						data: JSON.stringify(jsonObjects),
      						error:function(xhr){
...
function retrieveActivityGoal(){
                      ...
                      var goal;
  			         	...
  			         	jQuery.ajax({
      						url: "http://ict4d01.cs.uct.ac.za/facebook/jsondata/RAG/",
     						type: "POST",
      						contentType: "application/json",
      						data: JSON.stringify(jsonObjects),
      						error:function(xhr){
